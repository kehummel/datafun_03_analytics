...
def process_text_file():
    ...
    input_file = pathlib.Path(FETCHED_DATA_DIR, "hamlet.txt")


    # TODO: Replace with path to your text processed file
    output_file = pathlib.Path(PROCESSED_DIR, "text_the_word_count.txt")
...
#   TODO: Replace with the word you want to count from your text file
    words_to_count: str = "Hamlet"


    # TODO: Make any necessary changes to the logic
    words_count: int = count_word_occurrences(input_file, words_to_count)
    ...
    with output_file.open('w') as file:
        ...
        file.write(f"Occurrences of '{words_to_count}': {words_count}\n")
