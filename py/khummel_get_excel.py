...
def main():
    ...
    """
    excel_url = 'https://data.chhs.ca.gov/dataset/b0397867-b5c2-413e-8337-63582ab5ffd5/resource/50a39f30-87a5-45f3-9e4e-e729244b9a8d/download/odp_homeless-data.xlsx'
    logger.info("Starting Excel fetch demonstration...")
    fetch_excel_file(FETCHED_DATA_DIR, "Hospital_Homeless.xlsx", excel_url)
