...
FETCHED_DATA_DIR: str = "khummel_data"
...
def process_excel_file():
    ...
    input_file = pathlib.Path(FETCHED_DATA_DIR, "Hospital_Homeless.xlsx")

    # TODO: Replace with path to your Excel processed file
    output_file = pathlib.Path(PROCESSED_DIR, "HH_Processed.txt")
    ...
    tword_count = count_word_in_column(input_file, column_to_see, word_to_see)
    ...
    with output_file.open('w') as file:
        ...
        file.write(f"Occurrences of '{word_to_see}' in column {column_to_see}: {tword_count}\n")
