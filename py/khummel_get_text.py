...
def main():
    ...
    """
    txt_url = 'https://courses.cs.washington.edu/courses/cse391/19sp/lectures/7/hamlet.txt'
    logger.info("Starting text fetch demonstration...")
    fetch_txt_file(FETCHED_DATA_DIR, "hamlet.txt", txt_url)
